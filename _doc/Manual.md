...
```yml
# Site settings
title: c_kai Blog             # title of your website
SEOTitle: c_kai Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“c_kai Blog”** but I want the title shows in search engine is **“黄玄的博客 | c_kai Blog”** which is multi-language.
